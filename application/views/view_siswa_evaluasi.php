      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="card-body">
              ...
              <p>Ini adalah daftar evaluasi yang harus anda selesaikan dalam pembelajaran!</p>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  foreach ($dataevaluasi as $d) :?> 
                    <tr>
                        <td><?=$i++ ?></td>
                        <td><a href="<?php echo base_url(). 'siswa/detail_evaluasi/'.$d->id_evaluasi ?>" ><?=$d->nama_evaluasi ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
