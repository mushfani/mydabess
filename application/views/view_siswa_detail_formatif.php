...
| Detail Formatif TP Siswa </title><head>
        ...
        <div class="card info-card customers-card">
            <div class="card-body">
                ...
                <div class="d-flex align-items-center">
                    <div class="ps-3">
                        <form method="post" action="<?php echo base_url(). 'siswa/cek_formatif/' . $idformatif; ?>">
                            <?php 
                                ...
                                <div class="col">
                                    ...
                                    <input type="hidden" name="id_formatif" value="<?= $d->id_formatif?>">
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
