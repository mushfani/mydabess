                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="post" action="<?php echo base_url(). 'guru/tambah_mapel'; ?>">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control input_user" name="nama_mapel" id="nama_mapel" placeholder="nama mapel">
                        </div>
                        <div class="input-group mb-3">
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-ad"></i></span>
                          </div>
                          <input type="text" class="form-control input_user" name="kelas" id="kelas" placeholder="kelas">
                        </div>
                ...
                <tbody>
                  ...
                  foreach ($data as $d) :?>
                    <tr>
                        ...
                        <td><?=$d->kelas ?></td>
                        <td>
                          <a class="btn btn-warning"  href="<?php echo base_url().'guru/edit_mapel/'. $d->kode_mapel?>"> Edit </a>
                          <a class="btn btn-danger"  href="<?php echo base_url().'guru/delete_mapel/'. $d->kode_mapel?>"> Hapus </a>
                        </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
