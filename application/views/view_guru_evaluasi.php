      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="card-body">
              ...
              <p>Ini adalah daftar evaluasi yang tersedia dalam pembelajaran anda</p>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Tambah Evaluasi Pertemuan</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form method="post" action="<?php echo base_url(). 'guru/tambah_evaluasi'; ?>">
                        <div class="row mb-3">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control input_user" name="nama_evaluasi" id="nama_evaluasi" placeholder="nama evaluasi">
                        </div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  foreach ($datamaterijoin as $d) :?> 
                    <tr>
                        <td><?=$i++ ?></td>
                        <td><a href="<?php echo base_url(). 'guru/detail_evaluasi/'.$d->id_evaluasi ?>" ><?=$d->judul ?></a></td>
                        <td><?=$d->nama_evaluasi ?></td>
                        <td>
                          <a class="btn btn-warning" href="<?php echo base_url().'guru/edit_evaluasi/'. $d->id_evaluasi?>"> <i class="bx bx-edit-alt me-1"></i> </a>
                          <a class="btn btn-danger" href="<?php echo base_url().'guru/delete_evaluasi/'. $d->id_evaluasi?>"> <i class="bx bx-trash me-1"></i> </a>
                        </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
