            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <div class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Edit Evaluasi</span>
			</div>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukkan Data Evaluasi yang Akan diedit!</p>
                  </div>
                    ...
                    <?php } ?>
                    <form method="post" action="<?php echo base_url(). 'guru/do_edit_evaluasi'; ?>">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control input_user" name="nama_evaluasi" id="nama_evaluasi" value="<?=$dataevaluasi->nama_evaluasi ?>" placeholder="nama evaluasi">
                        </div>
