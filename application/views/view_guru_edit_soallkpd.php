            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <div class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Edit Soal LKPD </span>
			</div>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Masukkan Data Soal LKPD yang Akan diedit!</p>
                  </div>
                    ...
                    <?php } ?>
                    <form method="post" action="<?php echo base_url(). 'guru/do_edit_soallkpd/'.$datasoalevaluasi->id_soal ?>">
                        <div class="input-group mb-3">
                            <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-ad"></i></span>
                            </div>
                            <input type="hidden" name="id_soal" id="id_soal" value="<?=$idSoal?>">
                            <input type="hidden" name="id_lkpd" id="id_lkpd" value="<?=$idlkpd?>">
