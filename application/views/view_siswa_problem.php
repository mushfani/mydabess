...
| Problem Siswa </title><head>
<?php include 'master/navbar_siswa.php'; ?>

    <div class="pagetitle">
      <h1> Daftar Problem Siswa </h1>
      ...
      <div class="row">
        <div class="col-lg-12">
            <div class="card-body">
              ...
              <p>Ini adalah daftar Problem yang tersedia dalam pembelajaran anda</p>
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">Materi Problem</th>
                ...
                <tbody>
                  <?php $i = 1;
                    ...
                    <tr>
                        <td><?=$i++ ?></td>
                        <td><a href="<?php echo base_url(). 'siswa/detail_problem/'.$d->id_problem.'/'.$d->kode_materi ?>" ><?=$d->judul ?></a></td>
