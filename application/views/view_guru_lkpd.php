                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Tambah LKPD Pertemuan</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form method="post" action="<?php echo base_url(). 'guru/tambah_lkpd'; ?>">
                        <div class="row mb-3">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" class="form-control input_user" name="nama_lkpd" id="nama_lkpd" placeholder="nama lkpd">
                        </div>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  foreach ($datamaterijoin as $d) :?> 
                    <tr>
                        <td><?=$i++ ?></td>
                        <td><a href="<?php echo base_url(). 'guru/detail_lkpd/'.$d->id_lkpd ?>" ><?=$d->judul ?></a></td>
                        <td><?=$d->nama_lkpd ?></td>
                        <td>
                          <a class="btn btn-warning" href="<?php echo base_url().'guru/edit_lkpd/'. $d->id_lkpd?>"> <i class="bx bx-edit-alt me-1"></i> </a>
                          <a class="btn btn-danger" href="<?php echo base_url().'guru/delete_lkpd/'. $d->id_lkpd?>"> <i class="bx bx-trash me-1"></i> </a>
                        </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
