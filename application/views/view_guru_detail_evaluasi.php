<?php include 'master/header.php'; ?>
 | Evaluasi Detail Guru </title><head>
<?php include 'master/navbar_guru.php'; ?>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
            <div class="card-body">
              <h5 class="card-title">Soal Evaluasi</h5>
              <p>Ini adalah daftar soal evaluasi yang tersedia dalam pembelajaran anda</p>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Tambah Soal Evaluasi</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                      <form method="post" action="<?php echo base_url(). 'guru/tambah_soal_evaluasi'; ?>">
                        <div class="input-group mb-3">
                          <div class="input-group-append">
                            <span class="input-group-text"><i class="fas fa-ad"></i></span>
                          </div>
                          <input type="hidden" name="id_evaluasi" id="id_evaluasi" value="<?=$this->uri->segment(3)?>">
                ...
                <tbody>
                  ...
                  foreach ($datasoalevaluasi as $d) :?> 
                    <tr>
                        ...
                        <td><?=$d->skor ?></td>
                        <td>
                          <a class="btn btn-warning" href="<?php echo base_url().'guru/edit_soal_evaluasi/'. $d->id_soal.'/'.$dataidevaluasi?>"> <i class="bx bx-edit-alt me-1"></i> </a>
                          <a class="btn btn-danger" href="<?php echo base_url().'guru/delete_soal_evaluasi/'. $d->id_soal.'/'.$dataidevaluasi?>"> <i class="bx bx-trash me-1"></i> </a>
                        </td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
